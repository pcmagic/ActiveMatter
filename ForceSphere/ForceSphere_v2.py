...
def print_case_info(**problem_kwargs):
    ...
    print_ForceSphere_info(**problem_kwargs)
    return True
...
def main_fun(**main_kwargs):
    ...
    sphere_obj0.set_velocity(sphere_V)
    #
    ...
    # loop
    prb_loop = problemClass.finiteDipole2DProblem(name=fileHandle, **problem_kwargs)
    ...
    prb_loop.relationHandle = single_obj_relation
    self._set_particle()
    self.addInteraction()
    return True
