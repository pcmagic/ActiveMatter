...
%%   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if mod(kkk-1,4) == 0                                                       %四阶龙格库塔法中实际的步数：1,5,9,...
if kkk == 1
    U5 = U;    W5 = W;
end                                                                        %初始的平移速度和角速度     
N_count = (kkk+3)/4;                                                       %四阶龙格库塔法中实际的步数
%=====================================================================================================================================================================
% 均方位移（Mean-Squared Displacement(MSD)）
%=====================================================================================================================================================================
for i = 1:NS
    Sds(i,:) = Sds(i,1:2) + U5(i,1:2)*time_h;
end
SMD = 0;
for i = 1:NS
    SMD = SMD + norm(Sds(i,:));
...
SMD = SMD/NS;
%=====================================================================================================================================================================
% 扩散系数（Diffusion Coefficient(D)）(2D：4；3D：6)
%=====================================================================================================================================================================
Deff = 1/(4*times)*SMD;
%=====================================================================================================================================================================
% the average-defined polarity
...
Utol1 = zeros(1,2);
for i = 1:NS
    Utol1 = Utol1 + U5(i,:)/norm(U5(i,:));
end
Polatity1 = norm(Utol1/NS);

Utol2 = zeros(1,2);
for i = 1:NS
    Utol2 = Utol2 + D3(i,1:2);
end
Polatity2 = norm(Utol2/NS);
%% 
%=====================================================================================================================================================================
% 动态示意图
%=====================================================================================================================================================================
if mod(kkk-1,N_fig) == 0
figure(1); clf;
for i = 1:NS
    surf(radii(i)*XSC+X(i,1),radii(i)*YSC+X(i,2),radii(i)*ZSC+X(i,3));
    hold on;
end 
quiver3(X(1:NS,1),X(1:NS,2),radii(1:NS,1),U(1:NS,1),U(1:NS,2),0*radii(1:NS,1),'color','b','LineWidth',1.5,'MaxHeadSize',0.1);  hold on;
colormap([1 0 0]); hold on;
drawnow; camlight; axis equal; box on; shading interp;
...
if mod(kkk-1,N_save) == 0
saveas(figure(1),num2str(kkk-1),'png');
saveas(figure(1),num2str(kkk-1),'fig');
%disp(kkk);  toc;
%feature('memstats');                                                      %电脑内存占用情况 
%whos                                                                      %命令whos和whos global可以分别查看所有局部和全局变量占用的内存大小
end
end
%% 
%=====================================================================================================================================================================
...
%=====================================================================================================================================================================
if mod(kkk-1,N_dat) == 0
fprintf(fid1,'%10.6f\t',times/dt0);          fprintf(fid1,'%d\n',NS);     
for i = 1:NS   
    fprintf(fid1,'%14.8f\t',X(i,1));         fprintf(fid1,'%14.8f\n',X(i,2));
end                                                                        %构象 

fprintf(fid2,'%10.6f\t',times/dt0);          fprintf(fid2,'%d\n',NS);
for i = 1:NS 
    fprintf(fid2,'%14.8f\t',D3(i,1));        fprintf(fid2,'%14.8f\n',D3(i,2));    
end                                                                        %Material Frame

fprintf(fid3,'%10.6f\t',times/dt0);          fprintf(fid3,'%d\n',NS); 
for i = 1:NS
    fprintf(fid3,'%14.8f\t',U5(i,1));        fprintf(fid3,'%14.8f\n',U5(i,2));  %每个球的平移速度
end

fprintf(fid4,'%10.6f\t',times/dt0);          fprintf(fid4,'%d\n',NS); 
for i = 1:NS
    fprintf(fid4,'%14.8f\n',W5(i,1));                                      %每个球的角速度
end 

fprintf(fid6,'%10.6f\t',times/dt0);
fprintf(fid6,'%18.15f\n',SMD);                                             % 均方位移（Mean-Squared Displacement(MSD)）

fprintf(fid7,'%10.6f\t',times/dt0);
fprintf(fid7,'%18.15f\n',Deff);                                            % 扩散系数（Diffusion Coefficient(D)）

fprintf(fid8,'%10.6f\t',times/dt0);
fprintf(fid8,'%18.15f\n',Polatity1);                                       % the average-defined polarity

fprintf(fid9,'%10.6f\t',times/dt0);
fprintf(fid9,'%18.15f\n',Polatity2);
end
end                                                                        %四阶龙格库塔方法实际处理循环结束
